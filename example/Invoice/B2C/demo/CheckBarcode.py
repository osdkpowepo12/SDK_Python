...
# 2.寫入基本介接參數
ecpay_invoice.Invoice_Method = 'CHECK_BARCODE'
ecpay_invoice.Invoice_Url = 'https://einvoice-stage.ecpay.com.tw/B2CInvoice/CheckBarcode'
...
if 'RtnCode' in aReturn_Info and  aReturn_Info['RtnCode'] == 1 and 'IsExist' in aReturn_Info:
    print('手機條碼是否存在', "存在" if aReturn_Info['IsExist']=="Y" else "不存在")